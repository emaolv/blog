module.exports = {
    ...
    '/ebook/coo/爆款抖音短视频/' : require('../ebook/coo/爆款抖音短视频/sidebar'),
    '/ebook/coo/引爆写作力/' : require('../ebook/coo/引爆写作力/sidebar'),
    '/ebook/coo/玩转教育直播间/' : require('../ebook/coo/玩转教育直播间/sidebar'),
    ...
    '/dev/language/java/' : require('../dev/language/java/sidebar'),
    '/dev/language/python/' : require('../dev/language/python/sidebar'),
    '/dev/language/go/' : require('../dev/language/go/sidebar'),
}